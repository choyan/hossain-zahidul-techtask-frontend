export default function RecipeSingle({ recipe }) {
  return (
    <div className="mb-4" key={recipe.title}>
        ...
        <div className="flex-1 min-w-0">
          <div className="focus:outline-none hover:border-2 hover:border-blue-500 cursor-pointer">
            ...
            {recipe.ingredients.map((item) => (
              <span className="inline-flex items-center px-2.5 py-0.5 mr-1.5 mb-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                {item}
              </span>
            ))}
          </div>
